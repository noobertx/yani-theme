...
Redux::setSection( $opt_name, array(
    ...
    'fields'        => array(
        ...
        array(
            ...
            'notice' => false,
            'style'  => 'info',
            'title'  => esc_html__( 'GDPR for Add Property', $theme_text_domain ),
            'desc'   => ''
        ),
        array(
            'id'       => 'add-prop-gdpr-enabled',
            'type'     => 'switch',
            'title'    => esc_html__( 'Enable/Disable GRPR on add property page.', $theme_text_domain ),
            'desc'     => '',
            'subtitle' => '',
            'default'  => 0,
            'on'       => 'Enabled',
        ...
        array(
            ...
            'type'     => 'text',
            'title'    => esc_html__( 'GDPR Label.', $theme_text_domain ),
            'desc'     => '',
            'subtitle' => '',
        ...
        array(
            ...
            'type'     => 'textarea',
            'title'    => esc_html__( 'GDPR Description', $theme_text_domain ),
            'desc'     => '',
            'subtitle' => '',
