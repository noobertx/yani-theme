<?php
global $yani_local;
$agent_position = get_post_meta( get_the_ID(), 'yani_agent_position', true );
$agent_company = get_post_meta( get_the_ID(), 'yani_agent_company', true );
?>
	...
	<div class="d-flex">
		...
		<div class="agent-list-content flex-grow-1">
			<div class="d-flex xxs-column">
				...
				<?php 
				if( yani_option( 'agent_review', 0 ) != 0 ) { 
			...
			<div class="d-flex sm-column">
				...
				<a class="agent-list-link" href="<?php the_permalink(); ?>"><strong><?php echo $yani_local['view_my_prop']; ?></strong></a>
			</div>
