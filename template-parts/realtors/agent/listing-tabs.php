...
if(yani_option('agent_tabs', 1)) {
    ...
    $agent_detail_tab_1 = yani_option('agent_detail_tab_1');
    $agent_detail_tab_2 = yani_option('agent_detail_tab_2');

    if(!empty($agent_detail_tab_1) || !empty($agent_detail_tab_2)) {

    $tab_1 = yani_get_term_by( 'term_id', $agent_detail_tab_1, 'property_status' );
    $tab_2 = yani_get_term_by( 'term_id', $agent_detail_tab_2, 'property_status' );
