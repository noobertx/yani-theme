<?php
if(yani_option('agency_tabs', 1)) {
    $agency_detail_tab_1 = yani_option('agency_detail_tab_1');
    $agency_detail_tab_2 = yani_option('agency_detail_tab_2');
    ...
    $tab_1 = yani_get_term_by( 'term_id', $agency_detail_tab_1, 'property_status' );
    $tab_2 = yani_get_term_by( 'term_id', $agency_detail_tab_2, 'property_status' );
    ...
    <ul class="nav nav-tabs">
        <li class="nav-item">
            <a class="nav-link <?php echo esc_attr( $tab_all ); ?>" href="<?php echo esc_url($all_link); ?>"><?php esc_html_e('All', _yani_theme()->get_text_domain());?></a>
        </li>
