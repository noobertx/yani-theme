<?php
$agency_facebook = get_post_meta( get_the_ID(), 'yani_agency_facebook', true );
$agency_twitter = get_post_meta( get_the_ID(), 'yani_agency_twitter', true );
$agency_linkedin = get_post_meta( get_the_ID(), 'yani_agency_linkedin', true );
$agency_googleplus = get_post_meta( get_the_ID(), 'yani_agency_googleplus', true );
$agency_youtube = get_post_meta( get_the_ID(), 'yani_agency_youtube', true );
$agency_pinterest = get_post_meta( get_the_ID(), 'yani_agency_pinterest', true );
$agency_instagram = get_post_meta( get_the_ID(), 'yani_agency_instagram', true );
$agency_vimeo = get_post_meta( get_the_ID(), 'yani_agency_vimeo', true );
$agency_mobile = get_post_meta( get_the_ID(), 'yani_agency_mobile', true );
$agency_whatsapp = get_post_meta( get_the_ID(), 'yani_agency_whatsapp', true );
