	...
	<div class="d-flex">
		...
		<div class="agent-list-content flex-grow-1">
			<div class="d-flex xxs-column">
				...
				<?php 
                if( yani_option( 'agency_review', 0 ) != 0 ) {
			...
			<div class="d-flex sm-column">
				...
				<a class="agent-list-link" href="<?php the_permalink(); ?>"><strong><?php esc_html_e('View Listings', _yani_theme()->get_text_domain()); ?></strong></a>
			</div>
