...
foreach ($taxnonomies as $slug => $name) {
	$count = yani_realtor_stats('property_status', 'yani_property_agency', get_the_ID(), $slug);
...
<div class="agent-profile-chart-wrap">
	<h2><?php echo wp_kses(__( '<span>Property</span> Status', 'houzez' ), yani_allowed_html() ); ?></h2>
