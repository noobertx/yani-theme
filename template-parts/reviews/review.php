...
<li id="review-<?php the_ID(); ?>" class="property-review">
	<div class="d-flex">
		<div class="review-image flex-grow-1">
			<img class="rounded-circle" src="<?php echo esc_url( yani_get_profile_pic() );?>" width="64" height="64" alt="thumb">
		</div>
		<div class="review-message">
			<div class="d-flex align-items-center">
				<h4 class="review-title"><?php the_title(); ?></h4>
				<div class="rating-score-wrap flex-grow-1">
					<?php echo yani_get_stars(get_post_meta(get_the_ID(), 'review_stars', true), false); ?>
				</div>
			</div><!-- d-flex -->
			...
			<div class="review-like mt-2">
				<ul class="likes-container-js list-inline">
					...
					<li class="list-inline-item review-like-button">
						<a class="hz-like-dislike-js" data-id="<?php echo intval(get_the_ID()); ?>" data-type="likes" data-msg="<?php esc_html_e('You have already voted', _yani_theme()->get_text_domain()); ?>">
					...
					<li class="list-inline-item review-dislike-button">
						<a class="hz-like-dislike-js" data-id="<?php echo intval(get_the_ID()); ?>" data-type="dislikes" data-msg="<?php esc_html_e('You have already voted', _yani_theme()->get_text_domain()); ?>">
