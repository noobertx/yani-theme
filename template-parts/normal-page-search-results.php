...
$search_result_layout = _yani_theme()->get_option('search_result_layout');
$search_num_posts = _yani_theme()->get_option('search_num_posts');
...
$search_qry = apply_filters( '_yani20_search_filters', $search_qry );
$search_qry = _yani_property_listing()->prop_sort( $search_qry );
$search_query = new WP_Query( $search_qry );


$total_records = $search_query->found_posts;

$record_found_text = esc_html__('Result Found', _yani_theme()->get_text_domain());
if( $total_records > 1 ) {
    $record_found_text = esc_html__('Results Found', _yani_theme()->get_text_domain());
}
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="<?php echo esc_attr($content_classes); ?>">
                ...
                <?php _yani_theme()->render_pagination( $search_query->max_num_pages ); ?>
