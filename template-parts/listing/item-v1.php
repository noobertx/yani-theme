...
<div class="item-listing-wrap hz-item-gallery-js card" <?php //yani_property_gallery('yani-item-image-1'); ?>>
	<div class="item-wrap item-wrap-v1 item-wrap-no-frame h-100">
		<div class="d-flex align-items-center h-100">
			...
			<?php if(_yani_theme()->get_option('disable_date', 1) || _yani_theme()->get_option('disable_agent', 1)) { ?>
