...
<div class="item-listing-wrap hz-item-gallery-js card" <?php yani_property_gallery('houzez-item-image-1'); ?>>
	<div class="item-wrap item-wrap-v2 item-wrap-no-frame h-100">
		<div class="d-flex align-items-center h-100">
			...
			<?php if(yani_option('disable_date', 1) || yani_option('disable_agent', 1)) { ?>
