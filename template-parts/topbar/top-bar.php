<?php
$top_bar_left = _yani_theme()->get_option('top_bar_left');
$top_bar_right = _yani_theme()->get_option('top_bar_right');
$top_bar_mobile = _yani_theme()->get_option('top_bar_mobile');
$hide_top_bar_mobile = '';
if( $top_bar_mobile != 0 ) {
...
<div class="top-bar-wrap <?php echo esc_attr($hide_top_bar_mobile); ?>">
	<div class="<?php echo esc_attr(_yani_theme()->get_option('top_bar_width')); ?>">
