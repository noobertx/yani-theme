...
$mp4 = get_post_meta($post->ID, 'yani_page_header_bg_mp4', true);
$webm = get_post_meta($post->ID, 'yani_page_header_bg_webm', true);
$ogv = get_post_meta($post->ID, 'yani_page_header_bg_ogv', true);

$video_image_id = get_post_meta($post->ID, 'yani_page_header_video_img', true);
...
$is_dock_search = '';
if(yani_option('adv_search_which_header_show')['header_video'] != 0) {
