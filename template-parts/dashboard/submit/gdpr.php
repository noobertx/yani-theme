...
<div id="hz-gdpr" class="dashboard-content-block-wrap <?php echo esc_attr($is_multi_steps);?>">
	<h2><?php echo yani_option( 'cls_gdpr', 'GDPR Agreement *' ); ?></h2>
		...
		<div class="row">
			<div class="col-md-12 col-sm-12">
				<div class="form-group">
                    ...
                    <?php echo yani_option('add-prop-gdpr-label'); ?>
			...
			<div class="col-md-12 col-sm-12">
				<div class="form-group">
                    <textarea rows="5" readonly="readonly" class="form-control"><?php echo yani_option('add-prop-gdpr-agreement-content');?></textarea>
                </div>
			</div>
		</div><!-- row -->			
