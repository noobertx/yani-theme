<?php
global $post, $taxonomy_name, $listing_view, $yani_local;
...
$is_sticky = '';
$sticky_sidebar = yani_option('sticky_sidebar');
if( $sticky_sidebar['property_listings'] != 0 ) { 
    $is_sticky = 'yani_sticky'; 
}

$listing_view = yani_option('taxonomy_posts_layout', 'list-view-v1');
$taxonomy_layout = yani_option('taxonomy_layout');
...
$taxonomy_content_position = yani_option('taxonomy_content_position', 'above');

$sort_args = array('post_status' => 'publish');
$sort_args = yani_prop_sort($sort_args);
global $wp_query;
...
$property_label = yani_option('cl_property', 'Property');
if( $total_listing_found > 1 ) {
   $property_label = yani_option('cl_properties', 'Properties'); 
}
?>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="<?php echo esc_attr($content_classes); ?>">
                ...
                <?php yani_pagination( $wp_query->max_num_pages ); ?>
