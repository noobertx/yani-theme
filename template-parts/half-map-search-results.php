...
$listing_view = yani_option('search_result_posts_layout', 'list-view-v1');
$search_result_layout = yani_option('search_result_layout');
$search_num_posts = yani_option('search_num_posts');
$enable_save_search = yani_option('enable_disable_save_search');
$page_content_position = yani_get_listing_data('listing_page_content_area');
...
$search_qry = yani_prop_sort ( $search_qry );
$search_query = new WP_Query( $search_qry );  
$total_properties = $search_query->found_posts; 

$enable_search = yani_option('enable_halfmap_search', 1);
$search_style = yani_option('halfmap_search_layout', 'v4');
...
<section class="half-map-wrap map-on-left clearfix">
    <div id="map-view-wrap" class="half-map-left-wrap">
        <div class="map-wrap">
            ...
            <?php if(yani_get_map_system() == 'google') { ?>
    ...
    <div id="half-map-listing-area" class="half-map-right-wrap <?php echo esc_attr($wrap_class); ?>">
        ...
        <div class="listing-view <?php echo esc_attr($view_class); ?>" data-layout="<?php echo esc_attr($item_layout); ?>">
            ...
            <div id="yani_ajax_container">
                ...
                <?php yani_ajax_pagination( $search_query->max_num_pages ); ?>
            </div>
