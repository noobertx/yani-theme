...
add_action( 'wp_head', 'yani_favicons_apple_icons' );
if ( ! function_exists( 'yani_favicons_apple_icons' ) ) {
    function yani_favicons_apple_icons() {
        ...
        // Vars
        $output = '';
        $favicon = yani_option('favicon', '', 'url');
        $iphone_icon = yani_option('iphone_icon', '', 'url');
        $iphone_icon_retina = yani_option('iphone_icon_retina', '', 'url');
        $ipad_icon = yani_option('ipad_icon', '', 'url');
        $ipad_icon_retina = yani_option('ipad_icon_retina', '', 'url');
