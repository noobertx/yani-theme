<?php
$call_us_img = yani_option( 'hd3_call_us_image', false, 'url' );
?>
		...
		<div class="header-contact header-contact-1">
			<div class="d-flex align-items-center">
				...
				<div class="header-contact-right">
					<?php echo esc_attr( yani_option('hd3_call_us_text') ); ?> <a href="tel://<?php echo esc_attr( yani_option('hd3_phone') ); ?>"><?php echo esc_attr( yani_option('hd3_phone') ); ?></a>
