...
if( isset( $_GET['selected_package'] ) ) {
    ...
    $pack_listings           = get_post_meta( $selected_package_id, 'yani_package_listings', true );
    $pack_featured_listings  = get_post_meta( $selected_package_id, 'yani_package_featured_listings', true );
    $pack_unlimited_listings = get_post_meta( $selected_package_id, 'yani_unlimited_listings', true );
    $pack_tax = get_post_meta( $selected_package_id, 'yani_package_tax', true );
    $pack_billing_period     = get_post_meta( $selected_package_id, 'yani_billing_time_unit', true );
    $pack_billing_frquency   = get_post_meta( $selected_package_id, 'yani_billing_unit', true );
    $yani_package_popular    = get_post_meta( $selected_package_id, 'yani_package_popular', true );
        ...
        <div class="dashboard-content-block">
            ...
            <div class="membership-package-order-detail">
                ...
                <ul class="list-unstyled mebership-list-info">
                    <li>
                        <i class="yani-icon icon-check-circle-1 mr-2 primary-text"></i> 
                    ...
                    <li>
                        <i class="yani-icon icon-check-circle-1 mr-2 primary-text"></i> 
                        <?php esc_html_e('Price', _yani_theme()->get_text_domain()); ?> 
