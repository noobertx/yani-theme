...
$price_featured_listing_submission = yani_option('price_featured_listing_submission');
...
$terms_conditions = yani_option('payment_terms_condition');
...
$enable_paypal = yani_option('enable_paypal');
$enable_stripe = yani_option('enable_stripe');
$enable_2checkout = yani_option('enable_2checkout');
$enable_wireTransfer = yani_option('enable_wireTransfer');
$is_upgrade = 0;
if( !empty( $upgrade_id ) ) {
    $is_upgrade = 1;
}
...
<div class="payment-method">
    ...
    <div class="payment-method-block stripe-method">
        <div class="form-group">
            ...
            <?php yani_stripe_payment_perlisting( $property_id, $price_listing_submission, $price_featured_listing_submission ); ?>
        </div>
    </div>
    <?php } ?>
